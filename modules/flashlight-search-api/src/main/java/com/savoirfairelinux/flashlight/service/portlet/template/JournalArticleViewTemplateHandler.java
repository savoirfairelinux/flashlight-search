...
/**
 * Template handler used to render a journal article search result in the portlet
 */
@Component(
    immediate = true,
    property = {
...
public class JournalArticleViewTemplateHandler extends BasePortletDisplayTemplateHandler {
    ...
    private static final String LANGUAGE_KEY_TEMPLATE = "template.journal.view";
    ...
    public String getClassName() {
        return JournalArticleViewTemplateHandler.class.getName();
    }
    ...
    public Map<String, TemplateVariableGroup> getTemplateVariableGroups(long classPK, String language, Locale locale) throws Exception {
        ...
        for(JournalArticleViewTemplateContextVariable variable : JournalArticleViewTemplateContextVariable.values()) {
