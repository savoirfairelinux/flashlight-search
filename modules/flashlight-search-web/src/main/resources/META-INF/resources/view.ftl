        ...
        >
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            <@liferay_portlet["renderURL"] var="facetURL">
                                ...
                                <@liferay_portlet["param"] name="keywords" value=keywords />
                            </@>
                            ...
                            <#list searchFacets as facet>
                                <#list facet.facet.facetCollector.termCollectors as term>
                                    <#if (groupedDocuments[term.term])?? && enabled_facets?seq_contains(facet.className) >
                                        <li><@liferay_aui["a"] href="#" onClick="facetFilter(['${facet.fieldName}' , '${term.term}'])" >${facets[term.term]!term.term} <span class="badge">${term.frequency}</span></@></li>
                                    </#if>
                                </#list>
                            </#list>
                        </ul>
            ...
            <#if isShowing >
                <div class="row">
                    ...
                    <#if enabled_facets?seq_contains("com.savoirfairelinux.facet.CreatedSearchFacet") >
                        <div class="col-md-1">
                    ...
                    <#if enabled_facets?seq_contains("com.liferay.portal.search.web.internal.facet.AssetCategoriesSearchFacet") >
                        <div class="col-md-2">
                ...
                <#list results as group>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ${facets[key]!key} <span class="badge">${group.documents?size}</span>
                        </div>
