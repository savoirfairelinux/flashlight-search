...
TRANSFERS="${TRANSFERS}:/srv/entreprise/liferay/patching-tool-dxp/patching-tool-2.0.5.zip "
TRANSFERS="${TRANSFERS}:/srv/entreprise/liferay/patching-tool-dxp/patching-tool-2.0.5.zip.md5 "
TRANSFERS="${TRANSFERS}:/srv/entreprise/liferay/fix-pack/liferay-fix-pack-de-7-7010.zip "
TRANSFERS="${TRANSFERS}:/srv/entreprise/liferay/fix-pack/liferay-fix-pack-de-7-7010.zip.md5 "
